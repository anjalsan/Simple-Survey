package com.example.anjalsaneen.survey;
...
public class SimpleActivity extends Activity {
    ...
    public static final String SAMPLE_APP = "Survey Example";
    public static final String SURVEY_HASH1 = "XXBJZYC";
    public static final String SURVEY_HASH2 = "X6B7HV3";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        s.onStart(this, SAMPLE_APP, SM_REQUEST_CODE, SURVEY_HASH1);
    }
    ...
    public void takeSurvey1(View view) {
        ...
        s.startSMFeedbackActivityForResult(this, SM_REQUEST_CODE, SURVEY_HASH1);
    }

    public void takeSurvey2(View view) {
        //This is how you display a survey for the user to take
        // Remember: you must supply the parent activity (e.g. this), your own request code (to differentiate from other activities), and the collector hash of the SDK collector you've created at SurveyMonkey.com
        s.startSMFeedbackActivityForResult(this, SM_REQUEST_CODE, SURVEY_HASH2);
    }

    public void takeSurveyFragment(View view) {
        //This is how you display a survey for the user to take
        // Remember: you must supply the parent activity (e.g. this), your own request code (to differentiate from other activities), and the collector hash of the SDK collector you've created at SurveyMonkey.com
        SimpleFragmentActivity.startActivity(this, SURVEY_HASH1);
    }
